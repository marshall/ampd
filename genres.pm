# genres.pm (lookup table for genres.)
$genres = [
	...
	'Soul', 			'Punk',				'Space',
	'Meditative', 		'Instrumental Pop',	'Instr. Rock',
	...
	'Avantgarde', 		'Gothic Rock', 		'Progr. Rock',
	'Psych. Rock', 		'Symphonic Rock', 	'Slow Rock',
	'Big Band', 		'Chorus', 			'Easy Listen',
	'Acoustic', 		'Humor',			'Speech',
	...
	'A capalla', 		'Euro-House', 		'Dance Hall' 
